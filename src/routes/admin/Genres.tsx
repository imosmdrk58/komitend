...
import GenresTable from "@/components/admin/table/GenresTable";
...
const Genres = () => {
  ...
  const { data, isPending } = useQuery({
    queryKey: ["genres", { page: Number(searchParams.get("page")) || 1 }],
    queryFn: async () => await getGenres({ page: Number(searchParams.get("page")) || 1 }),
    retry: false,
    staleTime: Infinity
  })
