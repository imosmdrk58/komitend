...
const ChaptersTable = ({ data, loading }: { data: any; loading: boolean }) => {
  ...
  return (
    <>
      <TableCard title="Chapters" description="List of all chapters">
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem className="cursor-pointer" asChild>
                            <Link to={`/admin/chapters/edit/${item.slug}`}>
                                Edit
                            </Link>
                          </DropdownMenuItem>
